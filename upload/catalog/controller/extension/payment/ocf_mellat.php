...
class ControllerExtensionPaymentOCFMellat extends Controller {
	...
	public function confirm() {
		...
		if ($order_info) {
			...
			$data['address_confirm'] = $this->url->link('extension/payment/ocf_mellat/callback', 'order_id=' . $order_id);
	...
	public function callback() {
		if ($this->session->data['payment_method']['code'] == 'ocf_mellat') {
			...
			$data['text_wait'] = $this->language->get('text_wait');
			$data['text_settle_yes'] = $this->language->get('text_settle_yes');
			$data['text_settle_no'] = $this->language->get('text_settle_no');
			...
			$data['text_saleOrderId'] = $this->language->get('text_saleOrderId');
			$data['text_saleReferenceId'] = $this->language->get('text_saleReferenceId');
